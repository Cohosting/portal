                ...
                <div className="border-t border-gray-200">
                    <table className="min-w-full divide-y divide-gray-300">
                        ...
                        <tbody className="divide-y divide-gray-200 bg-white">
                            {seats.map((seat, idx) => {
                  const memberName = seat.user?.name || seat.team_member?.name;
                  const memberImage =
                      seat.user?.imageUrl ||
                      seat.team_member?.imageUrl ||
                      `https://ui-avatars.com/api/?name=${memberName || 'John Doe'}`;
                      ...
                      <tr key={seat.seatNumber}>
                        ...
                        <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                            {seat.status === 'available' ? (
                                <button
                                    onClick={() => {
                                        setSelectedSeat({ ...seat, seatNumber: idx + 1 });
                                        setIsOpen(true);
                                    }}
                                    type="button"
                                ...
                                <button
                                    ...
                                    >
                                      Remove<span className="sr-only">, {memberName}</span>
                                  </button>
                              )}
                          </td>
                      </tr>
