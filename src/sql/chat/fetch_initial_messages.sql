-- RPC function to fetch initial messages with polymorphic sender information
CREATE FUNCTION fetch_initial_messages(
  conversation_id_param uuid,
  initial_limit_param integer
)
RETURNS TABLE (
  id uuid,
