...
const StripeConnect = ({ portal, stripeUser, stripeStatus, refetchStripeUser }) => {
    ...
    const getButtonText = () => {
        ...
        case 'incomplete':
            return 'Complete Stripe Account';
        case 'connected':
                ...
                <div className="text-center">
                  ...
                  <p className="mt-2 text-sm text-gray-600">
                      ...
                      {stripeStatus === 'incomplete' &&
                          'Your Stripe account needs additional information. Please complete your profile.'}
                      {stripeStatus === 'connected' &&
                          'Your Stripe account is connected but not fully verified.'}
                      {stripeStatus === 'not_connected' &&
                          'Link your Stripe account to start adding clients and managing payments.'}
                  </p>
              </div>
